---
layout: post
title: "Fluxadj 3: Diagnose surface flux terms from restoring"
date: 2020-08-07
...
Way2: 4000*1025*10/(10*86400) = 46.3  
...
Unit:
$(kgm^{-3}m)(kg/kg)/(g/kg s)\rightarrow kgm^{-2}s{-1}$
...
Way2: 1000*10/(10*86400*0.0347) = 0.33 
