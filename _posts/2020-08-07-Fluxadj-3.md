...
## **Explaination:**
### SHF convertion
*The **erg** is a unit of energy equal to 10^−7 joules (100 nJ). It originated in the centimetre–gram–second (CGS) system of units. It is not an SI unit. 
1 erg = 10^−7 J = 1 g⋅cm^2/s^2
*C is for degC
*msu is 
...
$$C/s ---> (Kgm^{-3})*(JKg^{-1}K^{-1})*(C/s) ---> (10^{-3}gcm^{-3}))*(10^7erg*10^{-3}g^{-1}C^{-1})*(C/s) --->
  (10^{-3}gcm^{-3})*10^4*(erg*g^{-1}C^{-1}) ----> (10^{-3}gcm^{-3})*(10^4g⋅cm^2s^{-2}*g^{-1}C^{-1})*(C/s) ---->
  10^{-3}*10^4gs{-3}cm^{-1} $$

This indicates that temp flux unit converting coefficient is:
10^{-3}*rho_sw*cp_sw = 1/hflux_factor
...
$ρC_p*\frac{T^{obs}-T^{eq}}{τ_T}\quad ---> H*ρC_p*\frac{T^{obs}-T^{eq}}{τ_T}\quad$
$g*s{-3}cm^{-1} ---> gs{-3}cm^{-1}cm ---> gs{-3} ---> W/m^2$
